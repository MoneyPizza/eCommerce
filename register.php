<?php
      ...
      $dataN = $_GET['dn'];
      $cod = rand(1,65535);
      $query="INSERT INTO Utenti(UTE_Mail,UTE_Password,UTE_Nome,UTE_Cognome,UTE_DataNascita,UTE_Cod) VALUES ('".$mail."','".$pass."','".$nome."','".$cognome."','".$dataN."','".$cod."');";
      $host="10.1.101.40";
